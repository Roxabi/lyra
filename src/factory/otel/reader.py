"""Read otel-raw JSONL archive + SQLite index for factory-otel (#2069)."""
...
from factory.otel.paths import factory_otel_db_path, factory_otel_jsonl_path

log = logging.getLogger(__name__)


def _default_jsonl_path() -> Path:
    return factory_otel_jsonl_path()


def _default_db_path() -> Path:
    return factory_otel_db_path()
