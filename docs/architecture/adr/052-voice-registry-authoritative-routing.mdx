...
| Image | `factory.image.generate.request.<worker_id>` *(2026-07-04: corrected to include generate segment — see packages/roxabi-contracts/src/roxabi_contracts/image/subjects.py)* |
