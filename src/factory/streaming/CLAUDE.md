# CLAUDE.md — src/factory/streaming/
...
- **SanitizedError boundary** — `EventEmitter` is the ONLY place in this package where exception
  ...
  `src/factory/transport/CLAUDE.md` and ADR-045/049.
...
- `src/factory/transport/CLAUDE.md` — Phase 1 (`SanitizedError`, `Result[T, E]`) — upstream of this package.
