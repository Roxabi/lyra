...
- **Files:** `artifacts/audits/2026-05-08-adr-consolidation-audit-1145.md` (write), `docs/architecture/adr/*.mdx` (read all 72)
- **Snippet shape:**
  ```md
  ...
  - 30 ± 2 after this PR
  ```
- **Verify:** `test -f artifacts/audits/2026-05-08-adr-consolidation-audit-1145.md && grep -c "^## Bucket:" artifacts/audits/2026-05-08-adr-consolidation-audit-1145.md`
...
|------|---------------|-----------|---------|
| T1 | doc-writer-A | — | Audit & decisions doc (`artifacts/audits/2026-05-08-adr-consolidation-audit-1145.md`) |
