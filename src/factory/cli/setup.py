...
async def _register_bot(
    ...
    from factory.core.commands.command_registry import collect_commands
    from factory.core.commands.command_router import CommandRouter
    ...
    except Exception as exc:  # noqa: BLE001 — DEBT:boundary-broad-catch# boundary: cli-entry
        typer.echo(
...
async def _register_all(config_path: str) -> None:
    ...
    from factory.adapters.discord.voice.discord_voice_commands import VOICE_COMMANDS
