...
EXEMPT=(
    ...
    "src/lyra/infrastructure/stores/agent_store.py"   # 341 lines — #396 refactor backlog
    ...
    "src/lyra/core/stores/turn_store.py"    # 301 lines — pending migration to infrastructure
)
