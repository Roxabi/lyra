...
- T01: 13 — conftest + fixtures
- T02: 14 — test_loader.py
- T03: 15 — test_renderer.py
- T04: 16 — test_supervisor.py
- T05: 17 — test_check_acl_matrix_retired.py
- T06: 18 — test_check_request_reply_flows.py
- T07: 19 — scripts/_acl_models.py
- T08: 20 — scripts/_loader.py
- T09: 21 — scripts/_renderer.py
- T10: 22 — scripts/_supervisor.py
- T11: 23 — scripts/_nk.py (Slice 1 stub)
- T12: 24 — scripts/check_acl_matrix_retired.py
- T13: 25 — scripts/check_request_reply_flows.py
- T14: 26 — scripts/gen_nkeys.py (router, Slice 1)
- T15: 27 — pyproject.toml [project.scripts]
- T16: 28 — importlinter contract
- T17: 29 — RED-GATE-V1
- T18: 30 — test_nk.py
- T19: 31 — test_genkeys_modes.py
- T20: 32 — test_sudo_user.py
- T21: 33 — test_file_modes.py
- T22: 34 — test_ensure_nk.py
- T23: 35 — scripts/_nk.py (SubprocessNkeyProvider)
- T24: 36 — scripts/gen_nkeys.py (key-aware modes)
- T25: 37 — RED-GATE-V2
- T26: 38 — test_parity_e2e.py
- T27: 39 — ci.yml nk install
- T28: 40 — RED-GATE-V3a
- T29: 41 — ci.yml:70,73 swap
- T30: 42 — Makefile swap
- T31: 43 — runbook 1 sudo strip
- T32: 44 — runbook 2 sudo strip
- T33: 45 — GETTING-STARTED nk install
- T34: 46 — RED-GATE-V3b
- T35: 47 — bash deletion
- T36: 48 — RED-GATE-V3c
