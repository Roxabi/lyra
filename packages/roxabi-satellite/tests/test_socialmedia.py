...
def test_build_list_groups_error_carries_worker_error() -> None:
    req = SocialMediaListGroupsRequest.model_validate(
        {
    ...
    resp = build_list_groups_error(req, "nope", worker_error=we)
