...
Runs as uid 1501 (factory-gh) inside lyra-clipool. Token never reaches Claude's
subprocess env (uid 1500). Tmpfs parent /run/factory-gh-token/ is 0700
helper-owned — mounted by Quadlet, NOT chmod'd here.

Unix socket dispenser (serve() on /run/factory-gh-token/dispenser.sock) lives in
...
async def mint(
    ...
    *,
    ...
    headers = {
        ...
        "User-Agent": "factory-gh-token-helper/0.1",
    }
