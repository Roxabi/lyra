...
def test_classify_exception_worker_crash_does_not_leak_exception_str() -> None:
...
def test_classify_exception_session_lost_does_not_leak_exception_str() -> None:
...
def test_classify_exception_parse_does_not_leak_byte_sequence() -> None:
