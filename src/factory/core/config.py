...
factory.config can import them without pulling in adapter libs (ADR-059 V6).
"""
...
def _default_pattern_configs() -> dict[str, dict]:
    ...
    from factory.core.commands.command_patterns import load_pattern_configs
...
# Kept here so factory.config can import them without pulling in discord.py or
