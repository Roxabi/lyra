...
def verify(
    matrix: Path = typer.Option(  # noqa: B008 — DEBT:typer-default-option
        Path(_DEFAULT_MATRIX),
        "--matrix",
        help="Path to acl-matrix.json.",
    ),
    seeds_dir: Path = typer.Option(  # noqa: B008 — DEBT:typer-default-option
    ...
    only: list[str] = typer.Option(  # noqa: B008 — DEBT:typer-default-option
        None,
        "--only",
