...
| #1089 | `factory-acl genkeys --regen-authconf` | nkeys rendered at 62 chars (valid = 56) | `nats-server` | minutes (M₁ down 2026-05-06) |
...
- Pattern applies to both **generated** files (factory-acl) and **static** files consumed by an external binary (nats.conf, lyra-monitor.service).
