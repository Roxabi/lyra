...
- T1: 10 — Add TTS_WORKERS/STT_WORKERS to queue_groups.py
- T2: 11 — Test NatsAdapterBase construction + ValueError
- T3: 12 — Test _validate_envelope — accept/drop/missing/count
- T4: 13 — Test _shutdown — drain before close, no unsubscribe
- T5: 14 — Test health() — connected, uptime_s, all fields
- T6: 15 — Test run() — signal registration, _wait_ready called
- T7: 16 — Implement NatsAdapterBase in adapter_base.py
- T8: 17 — Export NatsAdapterBase from nats/__init__.py
- T9: 18 — Test TTS adapter — no bare nats.connect(), TTS_WORKERS used
- T10: 19 — Refactor tts_adapter_standalone.py → TtsAdapterStandalone
- T11: 20 — Test STT adapter — no bare nats.connect(), STT_WORKERS used
- T12: 21 — Refactor stt_adapter_standalone.py → SttAdapterStandalone
- T13: 22 — Full suite — pytest + mypy all 5 files
