...
- T1: 9 — Add TIMEOUT constants
- T2: 10 — Replace _FakeDp sleep with shutdown event
- T3: 11 — Replace _FakeDcAdapter sleep with shutdown event
- T4: 12 — Add yield_once() helper
- T5: 13 — Replace sleep(0) with yield_once()
- T6: 14 — Fix SlowAgent sleep(10)
- T7: 15 — Fix message_pipeline_stt sleep(9999)
- T8: 16 — Fix debouncer_pool sleep(10)
- T9: 17 — Fix conftest_cli_pool sleep(3600)
- T10: 18 — Fix remaining sleep(N>0) in test files
- T11: 19 — Run full test suite
