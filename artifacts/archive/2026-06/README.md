# Artifact archive — 2026-06

Point-in-time dev-core outputs moved here during the obsolete-artifacts cleanup (Phases A–C).

| Folder | Contents | Active replacement |
|--------|----------|-------------------|
| `audits/` | Quality/code audits (May–Jun 2026) | CI gates + `artifacts/debt/` |
