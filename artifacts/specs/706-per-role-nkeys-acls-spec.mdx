...
| `lyra.system.ready` [^ready] | SUB | PUB | PUB | — | — | — | — |
...
| telegram-adapter | `lyra.inbound.telegram.>`, `lyra.system.ready` | `lyra.outbound.telegram.>` | ✓ | This issue |
| discord-adapter | `lyra.inbound.discord.>`, `lyra.system.ready` | `lyra.outbound.discord.>` | ✓ | This issue |
