...
Decouples factory.core from the concrete SQLite MessageIndex implementation
(factory.infrastructure.stores.base.message_index). Fixes the layering inversion where
...
class MessageIndexProtocol(Protocol):
    """Read/write structural protocol for MessageIndex consumers in factory.core.
