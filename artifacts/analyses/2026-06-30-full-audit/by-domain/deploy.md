...
### 5. [P2] ACL parity fixture has zero local pre-push enforcement — `.pre-commit-config.yaml` (pre-push hook → `scripts/qg run --stage pre-push`), `tests/scripts/fixtures/v3-pre-grant-group.json`
