...
[llmCLI #12](https://github.com/Roxabi/llmCLI/issues/12) lands.
...
- **Secondary:**
  ...
  - llmCLI worker (sister PR
    [#12](https://github.com/Roxabi/llmCLI/issues/12)) — cannot deploy
...
- PR #1104 and llmCLI
  [#12](https://github.com/Roxabi/llmCLI/issues/12) MUST reach
