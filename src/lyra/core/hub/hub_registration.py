...
class HubRegistrationMixin:
    ...
    if TYPE_CHECKING:
        ...
        def set_debounce_ms(self, ms: int) -> None: ...  # noqa: ARG002  — DEBT:protocol-private-ducktyping# justified: TYPE_CHECKING forward decl for real method on Hub
        def set_cancel_on_new_message(self, enabled: bool) -> None: ...  # noqa: ARG002  — DEBT:protocol-private-ducktyping# justified: TYPE_CHECKING forward decl for real method on Hub
