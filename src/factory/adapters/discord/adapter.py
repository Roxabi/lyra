...
from factory.adapters.discord.discord_outbound import (
    _discord_typing_worker,
    send as _send_impl,
)
from factory.adapters.discord.voice.discord_voice import VoiceSessionManager
from factory.adapters.discord.lifecycle import (
...
class DiscordAdapter(discord.Client, OutboundAdapterBase):
    ...
    def _make_emitter(
        ...
        from factory.adapters.discord.discord_formatting import _validate_inbound
        from factory.adapters.discord.discord_outbound import DiscordTypingIndicator
