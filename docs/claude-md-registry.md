...
| `src/factory/adapters/omp/CLAUDE.md` | `src/factory/adapters/omp/AGENTS.md` | OmpWorker NATS adapter — digest gate, `tool_input` suppression, `_result_sent` guard, SanitizedError discipline |
...
| `src/factory/infrastructure/CLAUDE.md` | `src/factory/infrastructure/AGENTS.md` | store implementations (engineering-standards layering) |
...
| `src/factory/obs/CLAUDE.md` | `src/factory/obs/AGENTS.md` | observability — live OTel tracing (`hub_tracer`/`otel_wiring`/`otlp_export`, wired into runtime, #2069) + forward-facing `ObservabilityProvider` Langfuse abstraction (`base`/`noop`, #1235) |
...
| `src/factory/infrastructure/turn_writer/CLAUDE.md` | `src/factory/infrastructure/turn_writer/AGENTS.md` | JetStream subscriber-writer for turns.db (#1331) — sole writer (storage.md) |
...
| `src/factory/infrastructure/jobs/CLAUDE.md` | `src/factory/infrastructure/jobs/AGENTS.md` | FACTORY_JOBS WorkQueue stream + DLQ router provisioning (messaging.md, #1203) |
...
| `src/factory/dashboard/CLAUDE.md` | `src/factory/dashboard/AGENTS.md` | control-plane BFF axis (observability.md) — session-ID footgun |
| `packages/roxabi-nats/CLAUDE.md` | `packages/roxabi-nats/AGENTS.md` | NATS transport SDK (contracts.md) |
| `packages/roxabi-contracts/CLAUDE.md` | `packages/roxabi-contracts/AGENTS.md` | NATS contract schemas (contracts.md) |
