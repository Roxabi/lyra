...
class SttMiddleware:
    ...
    async def _dispatch_error(hub: object, msg: InboundMessage, key: str) -> None:
        ...
        content = hub._msg_manager.get(key)  # type: ignore[union-attr] — DEBT:defensive-narrow-payloads
        await hub.dispatch_response(  # type: ignore[union-attr] — DEBT:defensive-narrow-payloads
