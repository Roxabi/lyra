...
> **Current truth** → [`docs/architecture/job-model.md`](../job-model.md){#current-truth}
...
Per ADR-076 (three NATS planes), the **typing** plane (`factory.typing.*`, display-feedback) is
