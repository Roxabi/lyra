...
Relocated from factory.adapters.shared.outbound_listener to factory.core.ports
so that factory.inbound can reference it without violating the
inbound-no-adapters importlinter contract (ADR-073 / #1666).
"""
