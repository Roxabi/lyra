...
Superseded by ADR-059 — circular-import remediation pattern (port lives in core, infrastructure imports the port) absorbed into the canonical hex/clean model.
