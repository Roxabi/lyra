...
- Supervisor entry: `imagecli_gen` in `deploy/conf.d/` (satellite process managed by machine-level supervisord; formerly `deploy/supervisor/conf.d/`, removed in #886)
