...
Relocated from src/factory/adapters/shared/_shared_streaming_emitter.py (issue #1279,
...
if TYPE_CHECKING:
    from factory.outbound.throttle import ThrottleCapability
...
from factory.outbound._emitter_run import _run_emitter
...
class OutboundEmitter:
    ...
    Relocated from _shared_streaming_emitter.StreamingSession.
